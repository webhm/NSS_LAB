...
class Enviar extends Models implements IModels
{
    ...
    public function getMailNotificacion(string $correo = 'mchangcnt@gmail.com')
    {
        ...
        $content = '<br />
                    Estimado(a).- <br /><br /><b>' . $documento['apellidosPaciente'] . ' ' . $documento['nombresPaciente'] . '</b> está ingresado un nuevo Examen de Laboratorio.
                    <br />
        ...
        $_html = Helper\Emails::loadTemplate(array(
            # Título del mensaje
            '{{title}}' => 'Nuevo Examen de Laboratorio  - MetroVirtual',
        ...
        $sendMail = $this->sendMailNotificacion($_html, $correo, 'Nuevo Examen de Laboratorio - MetroVirtual Hospital Metropolitano');

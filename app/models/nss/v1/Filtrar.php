    ...
    public function filtrarOrdenesDia(): array
    {
        ...
        try {
            ...
            foreach ($list as $key => $val) {
                ...
                if ($documento['fechaExamen'] == date('Y-m-d') && $documento['sc'] == '0018942226') {
    ...
    public function filtrarReglas()
    {
        ...
        foreach ($this->ordenes as $key) {
            ...
            if (
                ...
                # Reglas de Filtrado Personalizado _AC
                if (count($this->documento['dataClinica']) !== 0 && $this->documento['_AC'] == 1) {
                ...
                } else if (count($this->documento['dataClinica']) !== 0 || count($this->documento['dataMicro']) !== 0 && $this->documento['_AC'] == 0) {
                        ...
                        foreach ($this->documento['dataMicro'] as $k) {
                            ...
                            if (!is_null($key['xIdPrueba'])) {
                                ...
                                if ($key['xIdPrueba'] == $k['TestID']) {
                                    ...
                                    # Prueba Validación Personalizada S/N amerita cultivo.
                                    if ($key['xIdPrueba'] == '7200') {

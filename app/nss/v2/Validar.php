...
class Validar extends Models implements IModels
{
        ...
        try {
            ...
            foreach ($list as $key => $val) {
                ...
                if ($documento['fechaExamen'] !== date('Y-m-d')) {
                    ...
                    if ($i <= 1 && $documento['procesoValidacion'] == 0) {
    ...
    public function establecerValidacion()
    {
        ...
        try {
            ...
            foreach ($documento['reglasFiltrosEnvio'] as $key => $val) {
                ...
                if ($val['statusEnvio'] == 0 && $val['tipoValidacion'] == 0 && !is_null($val['xIdPrueba'])) {
    ...
    public function validar()
    {
        ...
        try {
            ...
            foreach ($this->ordenes as $key) {
                ...
                $this->establecerValidacion();

                $this->documento['_AC'] = 0;

                // Para Validaciones Evaluar
                if ($this->documento['tipoValidacion'] == 0 && ($this->documento['validacionClinica'] !== 0 || $this->documento['validacionMicro'] !== 0) && $this->documento['sc'] == $key['sc']) {

                    @unlink($this->documento['file']);
                    unset($this->documento['file']);
                    $this->documento['procesoValidacion'] = 1;
                    $this->documento['_AC'] = 99;
                ...
                } else if ($this->documento['tipoValidacion'] == 1 && $this->documento['validacionClinica'] == 1 && count($this->documento['dataMicro']) == 0 && $this->documento['sc'] == $key['sc']) {
                    ...
                    if (count($this->documento['validacionesParciales']) !== 0) {
                        @unlink($this->documento['file']);
                        unset($this->documento['file']);
                        $this->documento['_AC'] = 4;
    ...
    public function validarDataClinicaParcial($regla)
    {
        ...
        try {
            ...
            if ($regla['tipoValidacion'] == 1 && $regla['strValidacion'] == 2 && $this->documento['validacionClinica'] == 1) {
                if ($statusPrueba >= 4) {
                    $pruebaValidada = true;
                }
            }

            if ($regla['tipoValidacion'] == 1 && $regla['strValidacion'] == 3 && $this->documento['validacionMicro'] == 1) {
            ...
            if ($regla['tipoValidacion'] == 0 && $regla['strValidacion'] == 2) {
                # Es prueba d emicro pero se libera si todo el resultado de micro esta listo
                if ($statusPrueba < 4) {
                    $pruebaValidada = true;
                }
            ...
            if ($regla['tipoValidacion'] == 0 && $regla['strValidacion'] == 3) {
                # Es prueba d emicro pero se libera si todo el resultado de micro esta listo
                if ($statusPrueba < 4) {
                    $pruebaValidada = true;
                }
    ...
    public function validarDataClinica_PDF()
    {

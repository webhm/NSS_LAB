...
class Files extends \Twig_Extension
{
     ...
     * @return array con las rutas de todos los ficheros encontrados, un array vacío si no encontró ficheros
     */
    public static function get_files_in_dir_limit(string $dir, string $types = '', int $offset = 0, int $limit = 100): array
    {
        $array = array();
        if (is_dir($dir)) {
            foreach (glob($dir . '*' . $types) as $file) {
    ...
    public function getFunctions(): array
    {
        return array(
            ...
            new \Twig_Function('get_files_in_dir_limit', array($this, 'get_files_in_dir_limit')),
